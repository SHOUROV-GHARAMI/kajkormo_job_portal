...
<body>
  ...
  <div>
    ...
    <div class="grid-foot">
      ...
      <div>Our Resources<br>Tools<br>job<br>Help desk<br>Opportunities</div>
      <div>About us<br>How it work<br>Our objectives<br></div>
      <div>আমরা ক্লায়েন্টের জন্য একটি সাধারণ ক্ষেত্র প্রদান করি <br>এবং ফ্রিল্যান্সারা তাদের ক্লায়েন্টদের সাথে সহজেই <br> যোগাযোগ করতে পারে। এতে উভয় লাভবান হয়।</div>
